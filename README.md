...
Visualizes microclimate temperature time series and calculates [slope and equilibrium following the approach laid out by Gril et al. 2023](https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/2041-210X.14048). This script does not involve any TLS data. The figures' primary purpose is compare time series coverage and select a feasible study period. The code should be rather straightforward but must be adapted to your microclimate data structure. 
# FAQ
